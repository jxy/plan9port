...
9c  -Ifmt fmt/fmtlocale.c
9c  fmtlock2.c
9c  -Ifmt fmt/fmtnull.c
...
9c  bvprint.c
9c  bwrite.c
9ar rsc $PLAN9/lib/libbio.a bbuffered.o bfildes.o bflush.o bgetc.o bgetrune.o bgetd.o binit.o blethal.o boffset.o bprint.o bputc.o bputrune.o brdline.o brdstr.o bread.o bseek.o bvprint.o bwrite.o
cd ..
cd libregexp
echo cd `pwd`
9c  regcomp.c
